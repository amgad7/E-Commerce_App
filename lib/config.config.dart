...
import 'feature/home/domain/use_cases/clear_cart.dart' as _i479;
...
import 'feature/home/domain/use_cases/remove_cart_product.dart' as _i364;
import 'feature/home/domain/use_cases/update_cart_product.dart' as _i890;
import 'feature/home/presentation/bloc/home_bloc.dart' as _i605;
import 'feature/orders/data/data_sources/orders_ds.dart' as _i310;
import 'feature/orders/data/data_sources/orders_ds_impl.dart' as _i12;
import 'feature/orders/data/repositories/orders_repo_impl.dart' as _i506;
import 'feature/orders/domain/repositories/orders_repo.dart' as _i917;
import 'feature/orders/domain/use_cases/create_order.dart' as _i924;
import 'feature/orders/domain/use_cases/get_orders.dart' as _i63;
import 'feature/orders/presentation/bloc/orders_bloc.dart' as _i984;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i174.GetIt init({
    ...
    gh.factory<_i310.OrdersDs>(() => _i12.OrdersDsImpl(gh<_i237.ApiManager>()));
    gh.factory<_i917.OrdersRepo>(
        () => _i506.OrdersRepoImpl(gh<_i310.OrdersDs>()));
    gh.factory<_i924.CreateOrderUseCase>(
        () => _i924.CreateOrderUseCase(gh<_i917.OrdersRepo>()));
    gh.factory<_i63.GetOrdersUseCase>(
        () => _i63.GetOrdersUseCase(gh<_i917.OrdersRepo>()));
    gh.factory<_i984.OrdersBloc>(() => _i984.OrdersBloc(
          getOrdersUseCase: gh<_i63.GetOrdersUseCase>(),
          createOrderUseCase: gh<_i924.CreateOrderUseCase>(),
        ));
    ...
    gh.factory<_i479.ClearCartUseCase>(
        () => _i479.ClearCartUseCase(gh<_i773.HomeRepo>()));
    ...
    gh.factory<_i364.RemoveCartProductUseCase>(
        () => _i364.RemoveCartProductUseCase(gh<_i773.HomeRepo>()));
    gh.factory<_i890.UpdateCartProductUseCase>(
        () => _i890.UpdateCartProductUseCase(gh<_i773.HomeRepo>()));
    gh.lazySingleton<_i605.HomeBloc>(() => _i605.HomeBloc(
          ...
          removeCartProductUseCase: gh<_i364.RemoveCartProductUseCase>(),
          updateCartProductUseCase: gh<_i890.UpdateCartProductUseCase>(),
          clearCartUseCase: gh<_i479.ClearCartUseCase>(),
